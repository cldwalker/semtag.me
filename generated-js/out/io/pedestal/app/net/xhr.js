...
io.pedestal.app.net.xhr.success_QMARK_ = (function success_QMARK_(p__156266){
var map__156268 = p__156266;
var map__156268__$1 = ((cljs.core.seq_QMARK_(map__156268))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__156268):map__156268);
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__156268__$1,"\uFDD0:status");
...
io.pedestal.app.net.xhr.redirect_QMARK_ = (function redirect_QMARK_(p__156269){
var map__156271 = p__156269;
var map__156271__$1 = ((cljs.core.seq_QMARK_(map__156271))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__156271):map__156271);
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__156271__$1,"\uFDD0:status");
return cljs.core.boolean$(cljs.core.PersistentHashSet.fromArray([301,null,302,null,303,null,307,null], true).call(null,status));
});
io.pedestal.app.net.xhr.error_QMARK_ = (function error_QMARK_(p__156272){
var map__156274 = p__156272;
var map__156274__$1 = ((cljs.core.seq_QMARK_(map__156274))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__156274):map__156274);
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__156274__$1,"\uFDD0:status");
return (status >= 400);
});
...
try{return cljs.core.into(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__156275_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__156275_SHARP_,/\s*:\s+/);
}),headers));
}catch (e156277){if((e156277 instanceof Error))
{var e = e156277;
...
var request__delegate = function (id,uri,p__156278){
var map__156281 = p__156278;
var map__156281__$1 = ((cljs.core.seq_QMARK_(map__156281))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__156281):map__156281);
var on_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__156281__$1,"\uFDD0:on-error");
var on_success = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__156281__$1,"\uFDD0:on-success");
var retries = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__156281__$1,"\uFDD0:retries",0);
var priority = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__156281__$1,"\uFDD0:priority");
var headers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__156281__$1,"\uFDD0:headers");
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__156281__$1,"\uFDD0:body");
var request_method = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__156281__$1,"\uFDD0:request-method","GET");
...
}catch (e156282){if((e156282 instanceof Error))
{var e = e156282;
console.log(e);
return null;
} else
...
if (arguments.length > 2) {
  p__156278 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return request__delegate.call(this, id, uri, p__156278);
};
request.cljs$lang$maxFixedArity = 2;
request.cljs$lang$applyTo = (function (arglist__156283){
var id = cljs.core.first(arglist__156283);
arglist__156283 = cljs.core.next(arglist__156283);
var uri = cljs.core.first(arglist__156283);
var p__156278 = cljs.core.rest(arglist__156283);
return request__delegate(id, uri, p__156278);
});
