...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IHash$_hash$arity$1 = (function (this__9469__auto__){
var self__ = this;
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$ILookup$_lookup$arity$2 = (function (this__9474__auto__,k__9475__auto__){
var self__ = this;
return this__9474__auto__.cljs$core$ILookup$_lookup$arity$3(this__9474__auto__,k__9475__auto__,null);
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__9476__auto__,k10372,else__9477__auto__){
var self__ = this;
if((k10372 === "\uFDD0:state"))
{return self__.state;
} else
{if("\uFDD0:else")
{return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k10372,else__9477__auto__);
} else
{return null;
}
}
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__9481__auto__,k__9482__auto__,G__10371){
var self__ = this;
var pred__10374 = cljs.core.identical_QMARK_;
var expr__10375 = k__9482__auto__;
if((pred__10374.cljs$core$IFn$_invoke$arity$2 ? pred__10374.cljs$core$IFn$_invoke$arity$2("\uFDD0:state",expr__10375) : pred__10374.call(null,"\uFDD0:state",expr__10375)))
{return (new io.pedestal.app.queue.AppMessageQueue(G__10371,self__.__meta,self__.__extmap,null));
} else
{return (new io.pedestal.app.queue.AppMessageQueue(self__.state,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__9482__auto__,G__10371),null));
}
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (this__9488__auto__,writer__9489__auto__,opts__9490__auto__){
var self__ = this;
...
return cljs.core.pr_sequential_writer(writer__9489__auto__,pr_pair__9491__auto__,"#io.pedestal.app.queue.AppMessageQueue{",", ","}",opts__9490__auto__,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.fromArray([cljs.core.vector.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq(["\uFDD0:state",self__.state], 0))], true),self__.__extmap));
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$ICollection$_conj$arity$2 = (function (this__9479__auto__,entry__9480__auto__){
var self__ = this;
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$ISeqable$_seq$arity$1 = (function (this__9486__auto__){
var self__ = this;
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$ICounted$_count$arity$1 = (function (this__9478__auto__){
var self__ = this;
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this__9470__auto__,other__9471__auto__){
var self__ = this;
...
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__9473__auto__,G__10371){
var self__ = this;
return (new io.pedestal.app.queue.AppMessageQueue(self__.state,G__10371,self__.__extmap,self__.__hash));
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IMeta$_meta$arity$1 = (function (this__9472__auto__){
var self__ = this;
return self__.__meta;
});
io.pedestal.app.queue.AppMessageQueue.prototype.cljs$core$IMap$_dissoc$arity$2 = (function (this__9483__auto__,k__9484__auto__){
var self__ = this;
if(cljs.core.contains_QMARK_(cljs.core.PersistentHashSet.fromArray(["\uFDD0:state",null], true),k__9484__auto__))
...
{return (new io.pedestal.app.queue.AppMessageQueue(self__.state,self__.__meta,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(self__.__extmap,k__9484__auto__)),null));
}
});
io.pedestal.app.queue.AppMessageQueue.cljs$lang$type = true;
io.pedestal.app.queue.AppMessageQueue.cljs$lang$ctorPrSeq = (function (this__9508__auto__){
return cljs.core.list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq(["io.pedestal.app.queue/AppMessageQueue"], 0));
});
io.pedestal.app.queue.AppMessageQueue.cljs$lang$ctorPrWriter = (function (this__9508__auto__,writer__9509__auto__){
return cljs.core._write(writer__9509__auto__,"io.pedestal.app.queue/AppMessageQueue");
});
...
io.pedestal.app.queue.map__GT_AppMessageQueue = (function map__GT_AppMessageQueue(G__10373){
return (new io.pedestal.app.queue.AppMessageQueue((new cljs.core.Keyword("\uFDD0:state")).call(null,G__10373),null,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__10373,"\uFDD0:state")));
});
