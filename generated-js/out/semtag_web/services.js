...
semtag_web.services.put_search_title = (function put_search_title(input_queue,p__16232){
var map__16234 = p__16232;
var map__16234__$1 = ((cljs.core.seq_QMARK_(map__16234))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__16234):map__16234);
var message = map__16234__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16234__$1,"\uFDD0:query");
...
semtag_web.services.put_value_and_spinner_off = (function put_value_and_spinner_off(path,input_queue,value){
semtag_web.services.put_value(path,input_queue,value);
...
}),"\uFDD0:on-error",(function (p__16237){
var map__16238 = p__16237;
var map__16238__$1 = ((cljs.core.seq_QMARK_(map__16238))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__16238):map__16238);
var msg = map__16238__$1;
var xhr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16238__$1,"\uFDD0:xhr");
...
semtag_web.services.send_message.cljs$core$IMultiFn$_add_method$arity$3(semtag_web.services.send_message,"\uFDD0:default",(function (p__16239,input_queue){
var map__16240 = p__16239;
var map__16240__$1 = ((cljs.core.seq_QMARK_(map__16240))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__16240):map__16240);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16240__$1,"\uFDD0:value");
semtag_web.services.spinner_on(input_queue);
return semtag_web.services.GET([cljs.core.str("/"),cljs.core.str(value)].join(''),cljs.core.partial.cljs$core$IFn$_invoke$arity$3(semtag_web.services.put_value_and_spinner_off,cljs.core.PersistentVector.fromArray([cljs.core.keyword.cljs$core$IFn$_invoke$arity$1([cljs.core.str(value),cljs.core.str("-results")].join(''))], true),input_queue),input_queue);
}));
...
semtag_web.services.send_message.cljs$core$IMultiFn$_add_method$arity$3(semtag_web.services.send_message,"\uFDD0:search",(function (p__16241,input_queue){
var map__16242 = p__16241;
var map__16242__$1 = ((cljs.core.seq_QMARK_(map__16242))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__16242):map__16242);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16242__$1,"\uFDD0:params");
semtag_web.services.spinner_on(input_queue);
semtag_web.services.put_search_title(input_queue,params);
return semtag_web.services.GET([cljs.core.str("/search?query="),cljs.core.str((new cljs.core.Keyword("\uFDD0:query")).call(null,params)),cljs.core.str("&search_type="),cljs.core.str((new cljs.core.Keyword("\uFDD0:search-type")).call(null,params))].join(''),cljs.core.partial.cljs$core$IFn$_invoke$arity$3(semtag_web.services.put_value_and_spinner_off,cljs.core.PersistentVector.fromArray([semtag_web.services.search_id(params),"\uFDD0:search-results"], true),input_queue),input_queue);
}));
...
semtag_web.services.spinner_on(input_queue);
return semtag_web.services.GET([cljs.core.str("/type?name="),cljs.core.str(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(message,cljs.core.PersistentVector.fromArray(["\uFDD0:params","\uFDD0:name"], true)))].join(''),cljs.core.partial.cljs$core$IFn$_invoke$arity$3(semtag_web.services.put_value_and_spinner_off,cljs.core.PersistentVector.fromArray([semtag_web.services.type_id(message),"\uFDD0:type-results"], true),input_queue),input_queue);
}));
...
var G__16244 = (io.pedestal.app.messages.topic.cljs$core$IFn$_invoke$arity$1 ? io.pedestal.app.messages.topic.cljs$core$IFn$_invoke$arity$1(message) : io.pedestal.app.messages.topic.call(null,message));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.fromArray(["\uFDD0:page"], true),G__16244))
