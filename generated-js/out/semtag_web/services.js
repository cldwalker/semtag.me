...
semtag_web.services.put_search_title = (function put_search_title(input_queue,p__10842){
var map__10844 = p__10842;
var map__10844__$1 = ((cljs.core.seq_QMARK_(map__10844))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10844):map__10844);
var message = map__10844__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10844__$1,"\uFDD0:query");
return (io.pedestal.app.protocols.put_message.cljs$core$IFn$_invoke$arity$2 ? io.pedestal.app.protocols.put_message.cljs$core$IFn$_invoke$arity$2(input_queue,cljs.core.PersistentArrayMap.fromArray([io.pedestal.app.messages.type,"\uFDD0:set-value",io.pedestal.app.messages.topic,cljs.core.PersistentVector.fromArray([semtag_web.services.search_id(message),"\uFDD0:search-title"], true),"\uFDD0:value",cljs.core.format.cljs$core$IFn$_invoke$arity$variadic("Search results for '%s'",cljs.core.array_seq([query], 0))], true)) : io.pedestal.app.protocols.put_message.call(null,input_queue,cljs.core.PersistentArrayMap.fromArray([io.pedestal.app.messages.type,"\uFDD0:set-value",io.pedestal.app.messages.topic,cljs.core.PersistentVector.fromArray([semtag_web.services.search_id(message),"\uFDD0:search-title"], true),"\uFDD0:value",cljs.core.format.cljs$core$IFn$_invoke$arity$variadic("Search results for '%s'",cljs.core.array_seq([query], 0))], true)));
});
semtag_web.services.put_value = (function put_value(path,input_queue,value){
return (io.pedestal.app.protocols.put_message.cljs$core$IFn$_invoke$arity$2 ? io.pedestal.app.protocols.put_message.cljs$core$IFn$_invoke$arity$2(input_queue,cljs.core.PersistentArrayMap.fromArray([io.pedestal.app.messages.type,"\uFDD0:set-value",io.pedestal.app.messages.topic,path,"\uFDD0:value",value], true)) : io.pedestal.app.protocols.put_message.call(null,input_queue,cljs.core.PersistentArrayMap.fromArray([io.pedestal.app.messages.type,"\uFDD0:set-value",io.pedestal.app.messages.topic,path,"\uFDD0:value",value], true)));
});
...
}),"\uFDD0:on-error",(function (p__10847){
var map__10848 = p__10847;
var map__10848__$1 = ((cljs.core.seq_QMARK_(map__10848))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10848):map__10848);
var msg = map__10848__$1;
var xhr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10848__$1,"\uFDD0:xhr");
...
semtag_web.services.send_message.cljs$core$IMultiFn$_add_method$arity$3(semtag_web.services.send_message,"\uFDD0:default",(function (p__10849,input_queue){
var map__10850 = p__10849;
var map__10850__$1 = ((cljs.core.seq_QMARK_(map__10850))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10850):map__10850);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10850__$1,"\uFDD0:value");
...
var G__10852 = (io.pedestal.app.messages.topic.cljs$core$IFn$_invoke$arity$1 ? io.pedestal.app.messages.topic.cljs$core$IFn$_invoke$arity$1(message) : io.pedestal.app.messages.topic.call(null,message));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.fromArray(["\uFDD0:page"], true),G__10852))
...
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.fromArray(["\uFDD0:search"], true),G__10852))
