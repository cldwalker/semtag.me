...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11498_SHARP_){
return cljs.core.format.cljs$core$IFn$_invoke$arity$variadic("%s %s",cljs.core.array_seq([cljs.core.second(p1__11498_SHARP_),cljs.core.name(cljs.core.first(p1__11498_SHARP_))], 0));
}),cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3((function (p1__11497_SHARP_){
return cljs.core.second(p1__11497_SHARP_);
}),(function (a,b){
return (a > b);
...
*/
semtag_web.rendering.navigate_path = (function navigate_path(_,p__11499,input_queue){
var vec__11501 = p__11499;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11501,0,null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11501,1,null);
...
var dynamic_focus_messages__delegate = function (p__11502){
var map__11504 = p__11502;
var map__11504__$1 = ((cljs.core.seq_QMARK_(map__11504))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11504):map__11504);
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11504__$1,"\uFDD0:paths");
var screen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11504__$1,"\uFDD0:screen");
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11504__$1,"\uFDD0:params");
...
if (arguments.length > 0) {
  p__11502 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);
} 
return dynamic_focus_messages__delegate.call(this, p__11502);
};
dynamic_focus_messages.cljs$lang$maxFixedArity = 0;
dynamic_focus_messages.cljs$lang$applyTo = (function (arglist__11505){
var p__11502 = cljs.core.seq(arglist__11505);
return dynamic_focus_messages__delegate(p__11502);
});
...
var G__11507 = route;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:type",G__11507))
...
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:search",G__11507))
...
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:thing",G__11507))
...
*/
semtag_web.rendering.dynamic_href_sets_focus = (function dynamic_href_sets_focus(p__11508){
var map__11510 = p__11508;
var map__11510__$1 = ((cljs.core.seq_QMARK_(map__11510))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11510):map__11510);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11510__$1,"\uFDD0:event");
...
var screen = semtag_web.route.url__GT_screen.cljs$core$IFn$_invoke$arity$1(rel_uri);
...
return io.pedestal.app.render.events.send_on.cljs$core$IFn$_invoke$arity$4("\uFDD0:click",domina.css.sel.cljs$core$IFn$_invoke$arity$1([cljs.core.str(parent_selector),cljs.core.str(" a")].join('')),input_queue,(function (p1__11511_SHARP_){
return semtag_web.rendering.dynamic_href_sets_focus(cljs.core.PersistentArrayMap.fromArray(["\uFDD0:event",p1__11511_SHARP_.evt], true));
}));
});
semtag_web.rendering.href_sets_focus = (function href_sets_focus(p__11512){
var map__11514 = p__11512;
var map__11514__$1 = ((cljs.core.seq_QMARK_(map__11514))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11514):map__11514);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11514__$1,"\uFDD0:event");
var messages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11514__$1,"\uFDD0:messages");
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11514__$1,"\uFDD0:transform");
...
return cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.EMPTY,(function (G__11515){
return (function (G__11516){
...
semtag_web.rendering.render_search_form = (function render_search_form(renderer,p__11517,input_queue){
var vec__11519 = p__11517;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11519,0,null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11519,1,null);
...
semtag_web.rendering.render_tags_results = (function render_tags_results(_,p__11520,___$1){
var vec__11522 = p__11520;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11522,0,null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11522,1,null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11522,2,null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11522,3,null);
return domina.insert_after_BANG_(domina.by_id("url_search_text"),semtag_web.partials.generate_datalist(new_value));
});
semtag_web.rendering.url_search = (function url_search(p__11523){
...
return io.pedestal.app.messages.fill.cljs$core$IFn$_invoke$arity$3(transform,messages,cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(search_map,"\uFDD0:name",search_id,cljs.core.array_seq(["\uFDD0:paths",semtag_web.rendering.dynamic_paths("\uFDD0:search",search_id)], 0)));
});
semtag_web.rendering.create_url = (function create_url(p__11526){
var map__11528 = p__11526;
var map__11528__$1 = ((cljs.core.seq_QMARK_(map__11528))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11528):map__11528);
var messages = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11528__$1,"\uFDD0:messages");
var transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11528__$1,"\uFDD0:transform");
...
semtag_web.rendering.set_search_title = (function set_search_title(renderer,p__11529,_){
var vec__11531 = p__11529;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11531,0,null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11531,1,null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11531,2,null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11531,3,null);
return domina.set_html_BANG_(domina.by_id("search_title"),new_value);
});
semtag_web.rendering.render_search_results = (function render_search_results(_,p__11532,input_queue){
var vec__11535 = p__11532;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11535,0,null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11535,1,null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11535,2,null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11535,3,null);
var map__11536 = new_value;
...
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11536__$1,"\uFDD0:tags");
var things = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11536__$1,"\uFDD0:things");
...
semtag_web.rendering.render_types_results = (function render_types_results(_,p__11537,input_queue){
...
semtag_web.rendering.render_tag_stats_results = (function render_tag_stats_results(_,p__11540,input_queue){
...
semtag_web.rendering.render_all_results = (function render_all_results(_,p__11543,input_queue){
var vec__11545 = p__11543;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11545,0,null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11545,1,null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11545,2,null);
...
semtag_web.rendering.render_thing_results = (function render_thing_results(_,p__11546,input_queue){
var vec__11548 = p__11546;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11548,0,null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11548,1,null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11548,2,null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11548,3,null);
var thing_id_11549 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(path,(cljs.core.count(path) - 2));
domina.set_html_BANG_(domina.by_id("content"),semtag_web.partials.generate_table.cljs$core$IFn$_invoke$arity$variadic("thing_show_table",cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_value,cljs.core.PersistentArrayMap.fromArray(["\uFDD0:attribute","\uFDD0:actions","\uFDD0:id",(new cljs.core.Keyword("\uFDD0:id")).call(null,cljs.core.first(new_value))], true)),cljs.core.array_seq(["\uFDD0:caption",(cljs.core.truth_(cljs.core.re_find(/\d+$/,thing_id_11549))?"":semtag_web.partials.link_tagged(thing_id_11549)),"\uFDD0:row-partial",semtag_web.partials.thing_row,"\uFDD0:fields",cljs.core.PersistentVector.fromArray(["\uFDD0:attribute","\uFDD0:value"], true)], 0)));
return semtag_web.rendering.enable_clickable_links_on("#thing_show_table td:not([data-field=url])",input_queue);
});
semtag_web.rendering.render_type_results = (function render_type_results(_,p__11550,input_queue){
var vec__11553 = p__11550;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11553,0,null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11553,1,null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11553,2,null);
var new_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11553,3,null);
var map__11554_11555 = new_value;
var map__11554_11556__$1 = ((cljs.core.seq_QMARK_(map__11554_11555))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11554_11555):map__11554_11555);
var tags_11557 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11554_11556__$1,"\uFDD0:tags");
var things_11558 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11554_11556__$1,"\uFDD0:things");
domina.set_html_BANG_(domina.by_id("content"),semtag_web.partials.generate_table.cljs$core$IFn$_invoke$arity$variadic("type_show_table",things_11558,cljs.core.array_seq(["\uFDD0:row-partial",semtag_web.partials.type_row,"\uFDD0:caption",[cljs.core.str("Total: "),cljs.core.str(cljs.core.count(things_11558))].join(''),"\uFDD0:fields",cljs.core.PersistentVector.fromArray(["\uFDD0:name","\uFDD0:url","\uFDD0:desc","\uFDD0:tags","\uFDD0:created-at"], true)], 0)));
domina.insert_before_BANG_(domina.by_id("type_show_table"),semtag_web.partials.table_stats.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([semtag_web.rendering.frequency_stat("Tag Type Counts",cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,tags_11557)),semtag_web.rendering.frequency_stat("Tag Counts",cljs.core.flatten(cljs.core.map.cljs$core$IFn$_invoke$arity$2("\uFDD0:tags",things_11558)))], 0)));
return semtag_web.rendering.enable_clickable_links_on("#type_show_table td:not([data-field=url])",input_queue);
});
semtag_web.rendering.render_alert_error = (function render_alert_error(_,p__11559,___$1){
var vec__11561 = p__11559;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11561,0,null);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11561,1,null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11561,2,null);
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11561,3,null);
