...
return (function (_,p__11565,input_queue){
var vec__11566 = p__11565;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11566,0,null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11566,1,null);
var transform_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11566,2,null);
var messages = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11566,3,null);
...
return (function (_,p__11569,input_queue){
var vec__11570 = p__11569;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11570,0,null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11570,1,null);
var transform_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11570,2,null);
var messages = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11570,3,null);
...
var click__delegate = function (path,dom_id,p__11571){
var map__11573 = p__11571;
var map__11573__$1 = ((cljs.core.seq_QMARK_(map__11573))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11573):map__11573);
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11573__$1,"\uFDD0:fn");
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11573__$1,"\uFDD0:inputs");
...
return click__delegate.call(this, path, dom_id, p__11571);
};
click.cljs$lang$maxFixedArity = 2;
click.cljs$lang$applyTo = (function (arglist__11574){
var path = cljs.core.first(arglist__11574);
arglist__11574 = cljs.core.next(arglist__11574);
var dom_id = cljs.core.first(arglist__11574);
var p__11571 = cljs.core.rest(arglist__11574);
return click__delegate(path, dom_id, p__11571);
});
