...
path_to.cljs$lang$applyTo = (function (arglist__10996){
...
var group__10977__auto___10998 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
semtag_web.partials.default_row = (function default_row(row,fields){
var elem__10978__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentVector.fromArray(["\uFDD0:tr",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10997_SHARP_){
return cljs.core.vec(cljs.core.PersistentVector.fromArray(["\uFDD0:td",(p1__10997_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__10997_SHARP_.cljs$core$IFn$_invoke$arity$1(row) : p1__10997_SHARP_.call(null,row))], true));
}),fields)], true)], 0));
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___10998);
return elem__10978__auto__;
});
semtag_web.partials.default_row.prototype._crateGroup = group__10977__auto___10998;
var group__10977__auto___11003 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
semtag_web.partials.generate_rows = (function generate_rows(data,p__11000){
var map__11002 = p__11000;
var map__11002__$1 = ((cljs.core.seq_QMARK_(map__11002))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11002):map__11002);
var row_partial = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11002__$1,"\uFDD0:row-partial",semtag_web.partials.default_row);
var fields = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11002__$1,"\uFDD0:fields");
var elem__10978__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentVector.fromArray(["\uFDD0:tbody",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10999_SHARP_){
return (row_partial.cljs$core$IFn$_invoke$arity$2 ? row_partial.cljs$core$IFn$_invoke$arity$2(p1__10999_SHARP_,fields) : row_partial.call(null,p1__10999_SHARP_,fields));
}),data)], true)], 0));
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___11003);
return elem__10978__auto__;
});
semtag_web.partials.generate_rows.prototype._crateGroup = group__10977__auto___11003;
var group__10977__auto___11008 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
semtag_web.partials.generate_table = (function() { 
var generate_table__delegate = function (table_id,data,p__11005){
var map__11007 = p__11005;
var map__11007__$1 = ((cljs.core.seq_QMARK_(map__11007))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__11007):map__11007);
var options = map__11007__$1;
var fields = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11007__$1,"\uFDD0:fields");
var elem__10978__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([(function (){var headers = (function (){var or__3943__auto__ = (new cljs.core.Keyword("\uFDD0:headers")).call(null,options);
...
return cljs.core.vec(cljs.core.PersistentVector.fromArray(["\uFDD0:th",p1__11004_SHARP_], true));
});})(headers))
,headers)], true)], true),semtag_web.partials.generate_rows(data,options)], true);
})()], 0));
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___11008);
return elem__10978__auto__;
};
var generate_table = function (table_id,data,var_args){
var p__11005 = null;
if (arguments.length > 2) {
  p__11005 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return generate_table__delegate.call(this, table_id, data, p__11005);
};
generate_table.cljs$lang$maxFixedArity = 2;
generate_table.cljs$lang$applyTo = (function (arglist__11009){
var table_id = cljs.core.first(arglist__11009);
arglist__11009 = cljs.core.next(arglist__11009);
var data = cljs.core.first(arglist__11009);
var p__11005 = cljs.core.rest(arglist__11009);
return generate_table__delegate(table_id, data, p__11005);
});
generate_table.cljs$core$IFn$_invoke$arity$variadic = generate_table__delegate;
return generate_table;
})()
;
semtag_web.partials.generate_table.prototype._crateGroup = group__10977__auto___11008;
var group__10977__auto___11010 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
semtag_web.partials.table_stats = (function() { 
var table_stats__delegate = function (stats){
var elem__10978__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentVector.fromArray(["\uFDD0:h4#table_stats",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (stat){
...
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___11010);
return elem__10978__auto__;
};
...
table_stats.cljs$lang$applyTo = (function (arglist__11011){
var stats = cljs.core.seq(arglist__11011);
...
tag_search_row.cljs$lang$applyTo = (function (arglist__11013){
var row = cljs.core.first(arglist__11013);
var fields = cljs.core.rest(arglist__11013);
...
;
semtag_web.partials.tag_search_row.prototype._crateGroup = group__10977__auto___11012;
var group__10977__auto___11016 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
semtag_web.partials.tag_stats_row = (function() { 
var tag_stats_row__delegate = function (row,fields){
var elem__10978__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentVector.fromArray(["\uFDD0:tr",cljs.core.PersistentVector.fromArray(["\uFDD0:td",(function (){var vec__11015 = clojure.string.split.cljs$core$IFn$_invoke$arity$2((new cljs.core.Keyword("\uFDD0:tag")).call(null,row),/=/);
var nsp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11015,0,null);
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11015,1,null);
...
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___11016);
return elem__10978__auto__;
};
...
tag_stats_row.cljs$lang$applyTo = (function (arglist__11017){
var row = cljs.core.first(arglist__11017);
var fields = cljs.core.rest(arglist__11017);
...
;
semtag_web.partials.tag_stats_row.prototype._crateGroup = group__10977__auto___11016;
var group__10977__auto___11018 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
...
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___11018);
return elem__10978__auto__;
};
...
type_stats_row.cljs$lang$applyTo = (function (arglist__11019){
var row = cljs.core.first(arglist__11019);
var fields = cljs.core.rest(arglist__11019);
...
;
semtag_web.partials.type_stats_row.prototype._crateGroup = group__10977__auto___11018;
var group__10977__auto___11020 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
...
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___11020);
return elem__10978__auto__;
};
...
type_row.cljs$lang$applyTo = (function (arglist__11021){
var row = cljs.core.first(arglist__11021);
var fields = cljs.core.rest(arglist__11021);
...
;
semtag_web.partials.type_row.prototype._crateGroup = group__10977__auto___11020;
var group__10977__auto___11022 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
...
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___11022);
return elem__10978__auto__;
};
...
all_row.cljs$lang$applyTo = (function (arglist__11023){
var row = cljs.core.first(arglist__11023);
var fields = cljs.core.rest(arglist__11023);
...
;
semtag_web.partials.all_row.prototype._crateGroup = group__10977__auto___11022;
var group__10977__auto___11026 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
semtag_web.partials.thing_row = (function() { 
var thing_row__delegate = function (row,fields){
var elem__10978__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([(function (){var attr = (new cljs.core.Keyword("\uFDD0:attribute")).call(null,row);
return cljs.core.PersistentVector.fromArray(["\uFDD0:tr",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:data-id",(new cljs.core.Keyword("\uFDD0:id")).call(null,row)], true),cljs.core.PersistentVector.fromArray(["\uFDD0:td",attr], true),(function (){var G__11025 = attr;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:actions",G__11025))
...
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:updated-at",G__11025))
{return semtag_web.partials.td_timestamp((new cljs.core.Keyword("\uFDD0:value")).call(null,row));
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:created-at",G__11025))
{return semtag_web.partials.td_timestamp((new cljs.core.Keyword("\uFDD0:value")).call(null,row));
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:desc",G__11025))
{return semtag_web.partials.td_desc.cljs$core$IFn$_invoke$arity$2((new cljs.core.Keyword("\uFDD0:value")).call(null,row),1000);
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:tagged",G__11025))
...
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___11026);
return elem__10978__auto__;
};
...
thing_row.cljs$lang$applyTo = (function (arglist__11027){
var row = cljs.core.first(arglist__11027);
var fields = cljs.core.rest(arglist__11027);
...
;
semtag_web.partials.thing_row.prototype._crateGroup = group__10977__auto___11026;
var group__10977__auto___11029 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
semtag_web.partials.generate_datalist = (function generate_datalist(tags){
var elem__10978__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentVector.fromArray(["\uFDD0:datalist#tags",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11028_SHARP_){
return cljs.core.vec(cljs.core.PersistentVector.fromArray(["\uFDD0:option",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:value",p1__11028_SHARP_], true)], true));
}),tags)], true)], 0));
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___11029);
return elem__10978__auto__;
});
semtag_web.partials.generate_datalist.prototype._crateGroup = group__10977__auto___11029;
var group__10977__auto___11030 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
...
elem__10978__auto__.setAttribute("crateGroup",group__10977__auto___11030);
return elem__10978__auto__;
});
semtag_web.partials.alert.prototype._crateGroup = group__10977__auto___11030;
