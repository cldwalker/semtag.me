...
path_to.cljs$lang$applyTo = (function (arglist__10987){
...
return cljs.core.PersistentVector.fromArray(["\uFDD0:a",cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentArrayMap.fromArray(["\uFDD0:href",semtag_web.partials.path_to.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq(["#/thing","?id=",unique_id], 0))], true),attr], 0)),text], true);
});
...
var group__10968__auto___10989 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
semtag_web.partials.default_row = (function default_row(row,fields){
var elem__10969__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentVector.fromArray(["\uFDD0:tr",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10988_SHARP_){
return cljs.core.vec(cljs.core.PersistentVector.fromArray(["\uFDD0:td",(p1__10988_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__10988_SHARP_.cljs$core$IFn$_invoke$arity$1(row) : p1__10988_SHARP_.call(null,row))], true));
}),fields)], true)], 0));
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___10989);
return elem__10969__auto__;
});
semtag_web.partials.default_row.prototype._crateGroup = group__10968__auto___10989;
var group__10968__auto___10994 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
semtag_web.partials.generate_rows = (function generate_rows(data,p__10991){
var map__10993 = p__10991;
var map__10993__$1 = ((cljs.core.seq_QMARK_(map__10993))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10993):map__10993);
var row_partial = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__10993__$1,"\uFDD0:row-partial",semtag_web.partials.default_row);
var fields = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10993__$1,"\uFDD0:fields");
var elem__10969__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentVector.fromArray(["\uFDD0:tbody",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10990_SHARP_){
return (row_partial.cljs$core$IFn$_invoke$arity$2 ? row_partial.cljs$core$IFn$_invoke$arity$2(p1__10990_SHARP_,fields) : row_partial.call(null,p1__10990_SHARP_,fields));
}),data)], true)], 0));
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___10994);
return elem__10969__auto__;
});
semtag_web.partials.generate_rows.prototype._crateGroup = group__10968__auto___10994;
var group__10968__auto___10999 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
semtag_web.partials.generate_table = (function() { 
var generate_table__delegate = function (table_id,data,p__10996){
var map__10998 = p__10996;
var map__10998__$1 = ((cljs.core.seq_QMARK_(map__10998))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10998):map__10998);
var options = map__10998__$1;
var fields = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10998__$1,"\uFDD0:fields");
var elem__10969__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([(function (){var headers = (function (){var or__3943__auto__ = (new cljs.core.Keyword("\uFDD0:headers")).call(null,options);
...
return cljs.core.vec(cljs.core.PersistentVector.fromArray(["\uFDD0:th",p1__10995_SHARP_], true));
});})(headers))
,headers)], true)], true),semtag_web.partials.generate_rows(data,options)], true);
})()], 0));
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___10999);
return elem__10969__auto__;
};
var generate_table = function (table_id,data,var_args){
var p__10996 = null;
if (arguments.length > 2) {
  p__10996 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return generate_table__delegate.call(this, table_id, data, p__10996);
};
generate_table.cljs$lang$maxFixedArity = 2;
generate_table.cljs$lang$applyTo = (function (arglist__11000){
var table_id = cljs.core.first(arglist__11000);
arglist__11000 = cljs.core.next(arglist__11000);
var data = cljs.core.first(arglist__11000);
var p__10996 = cljs.core.rest(arglist__11000);
return generate_table__delegate(table_id, data, p__10996);
});
generate_table.cljs$core$IFn$_invoke$arity$variadic = generate_table__delegate;
return generate_table;
})()
;
semtag_web.partials.generate_table.prototype._crateGroup = group__10968__auto___10999;
var group__10968__auto___11001 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
semtag_web.partials.table_stats = (function() { 
var table_stats__delegate = function (stats){
var elem__10969__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentVector.fromArray(["\uFDD0:h4#table_stats",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (stat){
...
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___11001);
return elem__10969__auto__;
};
...
table_stats.cljs$lang$applyTo = (function (arglist__11002){
var stats = cljs.core.seq(arglist__11002);
...
tag_search_row.cljs$lang$applyTo = (function (arglist__11004){
...
;
semtag_web.partials.tag_search_row.prototype._crateGroup = group__10968__auto___11003;
var group__10968__auto___11007 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
semtag_web.partials.tag_stats_row = (function() { 
var tag_stats_row__delegate = function (row,fields){
var elem__10969__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentVector.fromArray(["\uFDD0:tr",cljs.core.PersistentVector.fromArray(["\uFDD0:td",(function (){var vec__11006 = clojure.string.split.cljs$core$IFn$_invoke$arity$2((new cljs.core.Keyword("\uFDD0:tag")).call(null,row),/=/);
var nsp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11006,0,null);
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11006,1,null);
...
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___11007);
return elem__10969__auto__;
};
...
tag_stats_row.cljs$lang$applyTo = (function (arglist__11008){
...
;
semtag_web.partials.tag_stats_row.prototype._crateGroup = group__10968__auto___11007;
var group__10968__auto___11009 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
...
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___11009);
return elem__10969__auto__;
};
...
type_stats_row.cljs$lang$applyTo = (function (arglist__11010){
...
;
semtag_web.partials.type_stats_row.prototype._crateGroup = group__10968__auto___11009;
var group__10968__auto___11011 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
...
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___11011);
return elem__10969__auto__;
};
...
type_row.cljs$lang$applyTo = (function (arglist__11012){
...
;
semtag_web.partials.type_row.prototype._crateGroup = group__10968__auto___11011;
var group__10968__auto___11013 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
...
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___11013);
return elem__10969__auto__;
};
...
all_row.cljs$lang$applyTo = (function (arglist__11014){
...
;
semtag_web.partials.all_row.prototype._crateGroup = group__10968__auto___11013;
var group__10968__auto___11017 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
/**
* @param {...*} var_args
*/
semtag_web.partials.thing_row = (function() { 
var thing_row__delegate = function (row,fields){
var elem__10969__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([(function (){var attr = (new cljs.core.Keyword("\uFDD0:attribute")).call(null,row);
return cljs.core.PersistentVector.fromArray(["\uFDD0:tr",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:data-id",(new cljs.core.Keyword("\uFDD0:id")).call(null,row)], true),cljs.core.PersistentVector.fromArray(["\uFDD0:td",attr], true),(function (){var G__11016 = attr;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:actions",G__11016))
...
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:updated-at",G__11016))
{return semtag_web.partials.td_timestamp((new cljs.core.Keyword("\uFDD0:value")).call(null,row));
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:created-at",G__11016))
{return semtag_web.partials.td_timestamp((new cljs.core.Keyword("\uFDD0:value")).call(null,row));
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:desc",G__11016))
{return semtag_web.partials.td_desc.cljs$core$IFn$_invoke$arity$2((new cljs.core.Keyword("\uFDD0:value")).call(null,row),1000);
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\uFDD0:tagged",G__11016))
...
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___11017);
return elem__10969__auto__;
};
...
thing_row.cljs$lang$applyTo = (function (arglist__11018){
...
;
semtag_web.partials.thing_row.prototype._crateGroup = group__10968__auto___11017;
var group__10968__auto___11020 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
semtag_web.partials.generate_datalist = (function generate_datalist(tags){
var elem__10969__auto__ = crate.core.html.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentVector.fromArray(["\uFDD0:datalist#tags",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11019_SHARP_){
return cljs.core.vec(cljs.core.PersistentVector.fromArray(["\uFDD0:option",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:value",p1__11019_SHARP_], true)], true));
}),tags)], true)], 0));
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___11020);
return elem__10969__auto__;
});
semtag_web.partials.generate_datalist.prototype._crateGroup = group__10968__auto___11020;
var group__10968__auto___11021 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(crate.core.group_id,cljs.core.inc);
...
elem__10969__auto__.setAttribute("crateGroup",group__10968__auto___11021);
return elem__10969__auto__;
});
semtag_web.partials.alert.prototype._crateGroup = group__10968__auto___11021;
