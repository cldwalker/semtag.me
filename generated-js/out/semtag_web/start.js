...
var G__11653 = behavior;
var G__11653__$1 = ((true)?cljs.core.assoc_in(G__11653,cljs.core.PersistentVector.fromArray(["\uFDD0:focus","\uFDD0:default"], true),screen):G__11653);
var G__11653__$2 = (cljs.core.truth_(route)?cljs.core.assoc_in(G__11653__$1,cljs.core.PersistentVector.fromArray(["\uFDD0:focus",screen], true),semtag_web.rendering.dynamic_paths(route,screen)):G__11653__$1);
return G__11653__$2;
});
...
var G__11655 = semtag_web.start.create_app(semtag_web.rendering.render_config());
semtag_web.start.setup_effects(G__11655,semtag_web.services.services_fn);
return G__11655;
});
