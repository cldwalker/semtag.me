...
{io.pedestal.app.protocols.put_message((new cljs.core.Keyword("\uFDD0:input")).call(null,app),cljs.core.PersistentArrayMap.fromArray([io.pedestal.app.messages.type,"\uFDD0:map-value",io.pedestal.app.messages.topic,cljs.core.PersistentVector.fromArray(["\uFDD0:page"], true),"\uFDD0:value","\uFDD0:search-form"], true));
...
var vec__11633 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__11631_SHARP_,/=/);
...
var G__11635 = behavior;
var G__11635__$1 = ((true)?cljs.core.assoc_in(G__11635,cljs.core.PersistentVector.fromArray(["\uFDD0:focus","\uFDD0:default"], true),screen):G__11635);
var G__11635__$2 = (cljs.core.truth_(cljs.core.re_find(/^search/,cljs.core.name(screen)))?cljs.core.assoc_in(G__11635__$1,cljs.core.PersistentVector.fromArray(["\uFDD0:focus",screen], true),cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["\uFDD0:app-model","\uFDD0:search",screen], true),cljs.core.PersistentVector.fromArray(["\uFDD0:app-model","\uFDD0:search-form"], true),cljs.core.PersistentVector.fromArray(["\uFDD0:app-model","\uFDD0:navbar"], true)], true)):G__11635__$1);
var G__11635__$3 = (cljs.core.truth_(cljs.core.re_find(/^thing/,cljs.core.name(screen)))?cljs.core.assoc_in(G__11635__$2,cljs.core.PersistentVector.fromArray(["\uFDD0:focus",screen], true),cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["\uFDD0:app-model","\uFDD0:thing",screen], true),cljs.core.PersistentVector.fromArray(["\uFDD0:app-model","\uFDD0:navbar"], true)], true)):G__11635__$2);
return G__11635__$3;
});
...
var app = io.pedestal.app.build(semtag_web.start.update_behavior(semtag_web.behavior.app,screen));
...
var G__11637 = semtag_web.start.create_app(semtag_web.rendering.render_config());
semtag_web.start.setup_effects(G__11637,semtag_web.services.services_fn);
return G__11637;
});
